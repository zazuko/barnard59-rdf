    ...
    try {
      if (this.voidDatasetDeclaration) {
        if (this.graph) {
          ...
          this.push(rdf.quad(counts, ns._void.triples, rdf.literal(this.tripleCount), this.voidDatasetDeclaration.graph))
          this.push(rdf.quad(counts, ns._void.entities, rdf.literal(this.entityCount), this.voidDatasetDeclaration.graph))
        } else {
